...
The formation is an \emph{abstract} because the \ff{price} attribute
...
A \emph{full application} of a pair---an attribute and
  an \emph{expression}---to an abstract
...
\end{phiquation}
%
An expression may be \emph{dataizated} by morphing its atoms first and then
