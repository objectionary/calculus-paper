...
\newcommand\phinoEvaluate[2]{\langle #1 \rangle%
...
\newcommand\phinoContextualize[3]{ \langle #1 {,}\; #2 \rangle \mathrel{\Rightarrow} \langle #3 \rangle}
...
The \emph{evaluation} function
  ...
  while the notation \(\phinoEvaluate{b_1}{n_2}\)
  means that \(b_1\) evaluates to \(n_2\)
  with a side-effect of shifting \(s_1\) to \(s_2\),
  in the universe \(e\):
\begin{phiquation*}
\infrule{f \lparen [[ B_1, L>f, B_2 ]] {,}\; s_1 \rparen \rightarrow \langle n {,}\; s_2 \rangle}{\phinoEvaluate{[[ B_1, L>f, B_2 ]]}{n}}
\end{phiquation*}
\end{definition}
...
The inference rules at \cref{fig:morphing} inductively describe
  ...
  until they stop matching.
The notation \(\phinoMorph{n_1}{e}{n_2}\)
  means that \(n_1\) morphs to \(n_2\)
  with a side-effect of moving \(s_1\) to \(s_2\),
  in the universe \(e\).
...
The inference rules in \cref{fig:dataization} inductively
  ...
  until they stop matching.
The notation \(\phinoDataize{n}{e}{d}\)
  means that \(n\) dataizes to \(d\)
  with a side-effect of moving \(s_1\) to \(s_2\),
  in the universe \(e\).
