...
\begin{phinoInference}
  \phinoName{F1}
  \phinoCondition{\delta := \delta_1 \times \delta_2}
  \phinoPremise{\phinoDataize{b.^}{e}{s}{\delta_1}{s}}
  \phinoPremise{\phinoDataize{b.|x|}{e}{s}{\delta_2}{s}}
  \phinoConclusion{\phinoEvaluate{b}{e}{s}{ e.number( e.bytes( data -> [[ D> \delta ]] ) ) }{s}}
\end{phinoInference}
\\
\begin{phinoInference}
  \phinoName{F2}
  \phinoCondition{\delta := \delta_1 + \delta_2}
  \phinoPremise{\phinoDataize{b.^}{e}{s}{\delta_1}{s}}
  \phinoPremise{\phinoDataize{b.|x|}{e}{s}{\delta_2}{s}}
  \phinoConclusion{\phinoEvaluate{b}{e}{s}{ e.number( e.bytes( data -> [[ D> \delta ]] ) ) }{s}}
\end{phinoInference}
