...
\adjustbox{max width=\linewidth,margin=0em .3em}{%
  \newrule{F1}\;%
  \ensuremath{\infer{\text{\phiq{\phinoEvaluate{b}{e}{s}{ e.number( e.bytes( data -> [[ D> \delta ]] ) ) }{s}}}}{%
    \text{\phiq{\phinoDataize{b.^}{e}{s}{\delta_1}{s}}}%
    &
    \text{\phiq{\phinoDataize{b.|x|}{e}{s}{\delta_2}{s}}}%
  }}%
  \; if\; \phiq{\delta := \delta_1 \times \delta_2}%
}
\\
\adjustbox{max width=\linewidth,margin=0em .3em}{%
  \newrule{F2}\;%
