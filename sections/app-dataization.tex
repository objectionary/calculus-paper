...
\begin{mdframed}
\centering
\iexec[maybe]{phino --pin=0.0.133 dataize --output=latex --sweet --nonumber --compress --canonize --meet-prefix=dataization --sequence --quiet --hide=Q.bytes --hide=Q.number --locator=Q.@ --focus=Q.@ --meet-length=3
--margin=240 --meet-popularity=1 --atoms=./examples/atoms.json ./examples/celsius.phi | sed '1d;$d' | perl _eolang/paper-phi.pl 'equation*' /dev/stdin > _tex/celsius-dataization.tex}
\resizebox{\linewidth}{!}{%
