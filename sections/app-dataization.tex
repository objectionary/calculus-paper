...
\begin{mdframed}
\centering
\iexec[maybe]{phino dataize --output=latex --sweet --nonumber --compress --canonize --meet-prefix=dataization --sequence --hide=Q.bytes --hide=Q.number --locator=Q.@ --focus=Q.@ --meet-length=3
