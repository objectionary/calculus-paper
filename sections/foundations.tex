...
\newcommand\scopeof[1]{{#1}_{\varsigma}}
\begin{definition}[Scope]
The \textbf{scope} of expression \(e\), denoted as \(\scopeof{e}\), is either
  \begin{inparaenum}[a)]
...
\end{phiquation*}
\end{mdframed}
\capt{Illustrative examples of scopes: the bars over the terms highlight \(\scopeof{e}\), the scope of \(e\).}
\label{fig:scopes}
\end{figure*}
